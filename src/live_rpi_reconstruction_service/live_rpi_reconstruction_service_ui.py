...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_bufferSize.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.spinBox_nIterations)
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.spinBox_pixelCount)
        self.verticalLayout_2.addLayout(self.formLayout_4)
        self.label_calibrationState = QtWidgets.QLabel(self.groupBox_parameters)
        self.label_calibrationState.setAlignment(QtCore.Qt.AlignCenter)
        self.label_calibrationState.setObjectName("label_calibrationState")
        self.verticalLayout_2.addWidget(self.label_calibrationState)
        self.formLayout_probeInfo = QtWidgets.QFormLayout()
        self.formLayout_probeInfo.setObjectName("formLayout_probeInfo")
        self.label_pixelSize = QtWidgets.QLabel(self.groupBox_parameters)
        self.label_pixelSize.setObjectName("label_pixelSize")
        self.formLayout_probeInfo.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_pixelSize)
        ...
        self.formLayout_probeInfo.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEdit_pixelSize)
        self.label_nModes = QtWidgets.QLabel(self.groupBox_parameters)
        self.label_nModes.setObjectName("label_nModes")
        self.formLayout_probeInfo.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_nModes)
        ...
        self.formLayout_probeInfo.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_nModes)
        self.label_oversampling = QtWidgets.QLabel(self.groupBox_parameters)
        self.label_oversampling.setObjectName("label_oversampling")
        self.formLayout_probeInfo.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_oversampling)
        self.lineEdit_oversampling = QtWidgets.QLineEdit(self.groupBox_parameters)
        self.lineEdit_oversampling.setReadOnly(True)
        self.lineEdit_oversampling.setObjectName("lineEdit_oversampling")
        self.formLayout_probeInfo.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_oversampling)
        self.verticalLayout_2.addLayout(self.formLayout_probeInfo)
        self.horizontalLayout_maskBackground = QtWidgets.QHBoxLayout()
        self.horizontalLayout_maskBackground.setObjectName("horizontalLayout_maskBackground")
        ...
        self.horizontalLayout_maskBackground.addWidget(self.checkBox_mask)
        ...
        self.horizontalLayout_maskBackground.addWidget(self.checkBox_background)
        self.verticalLayout_2.addLayout(self.horizontalLayout_maskBackground)
        ...
        self.label_pixelSize.setBuddy(self.lineEdit_pixelSize)
        self.label_nModes.setBuddy(self.lineEdit_nModes)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Buffer:"))
        ...
        self.label_calibrationState.setText(_translate("MainWindow", "Waiting for Calibration..."))
        self.label_pixelSize.setText(_translate("MainWindow", "Pixel Size:"))
        self.label_nModes.setText(_translate("MainWindow", "# of Modes:"))
